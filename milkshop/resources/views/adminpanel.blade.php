                  ...
                  <div class="x_content">
                    ...
                    @if(!empty($sum))
                      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="min-height: 125px;">
                          <h3 style="min-height: 65px; padding-top: 15px;">Sales this month</h3>
                          <div class="count" style="font-size: 30px;">Rs {{$sum}}</div>
                    ...
                    @if(!empty($quantitythismonth))                  
                      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="min-height: 125px;">
                        <h3 style="min-height: 65px; padding-top: 15px;">Quantity sold this month</h3>
                          <div class="count" style="font-size: 30px;">{{$quantitythismonth}} Liters</div>
                    ...
                    @if(!empty($avgprice))
                      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="min-height: 125px;">
                          <h3 style="min-height: 65px; padding-top: 15px;">Average Price per Liter</h3>
                          <div class="count" style="font-size: 30px;">Rs {{round($avgprice)}}</div>
                        </div>
                      </div>
                    @endif

                      @if(!empty($housesnumber))
                      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats" style="min-height: 125px;">
                          <h3 style="min-height: 65px; padding-top: 15px;">Active Houses</h3>
                          <div class="count" style="font-size: 30px;">{{$housesnumber}}</div>
                        </div>
                      </div>
                      @endif
                    </div>
                      ...
                      <tbody>
                           @foreach($billings as $body)
                              <tr>
                                ...
                                @if($body->find_model_id == $house->id)<td><a href="house={{$house->id}}">{{$house->address}}</a></td>@endif
                                @endforeach
                              </tr> 
                            @endforeach 
                      </tbody>
