            ...
            <div class="row">
              ...
              @endif
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="/houseadd" enctype="multipart/form-data" onSubmit="return validate();">
                        {{ csrf_field() }}
                      ...
                      <div class="item form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="price" name="price" required="required" class="form-control col-md-7 col-xs-12" placeholder="Price per Liter">
                      </div>
                      </div>
                      ...
                      <div class="item form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="address" name="address" required="required" class="form-control col-md-7 col-xs-12" placeholder="House Address">
                        </div>
                      </div>
                      <div class="item form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="phone" name="phone" required="required" placeholder="Phone Number" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
