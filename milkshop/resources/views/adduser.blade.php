        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              ...
              @endif
                    <h2>Add a new MilkMan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <form class="form-horizontal" role="form" method="POST" action="/addauser" enctype="multipart/form-data" onSubmit="return validate();">
                        {{ csrf_field() }}
                    

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Admin <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <span class="button-checkbox">
                            <button type="button" class="btn" data-color="info">Admin</button>
                            <input type="checkbox" class="hidden" name="admincheck" value="1"/>
                        </span>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first_name" name="first_name" required="required" class="form-control col-md-7 col-xs-12" placeholder="First Name" value="{{ old('first_name') }}">
                      ...
                      <div class="item form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last_name" name="last_name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Last Name" value="{{ old('last_name') }}">
                      ...
                      <div class="item form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="username" name="username" required="required" class="form-control col-md-7 col-xs-12" placeholder="Username" value="{{ old('username') }}">
                      ...
                      <div class="item form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" data-validate-linked="email" required="required" class="form-control col-md-7 col-xs-12" name="email" value="{{ old('email') }}" placeholder="Email Address">
                          @if ($errors->has('email'))
                                    <span class="help-block">
                      ...
                      <div class="item form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="address" name="address" required="required" class="form-control col-md-7 col-xs-12" placeholder="Address" value="{{ old('address') }}">
                      ...
                      <div class="item form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="phone" name="phone" required="required" placeholder="Phone Number" class="form-control col-md-7 col-xs-12" value="{{ old('phone') }}">
                           @if ($errors->has('phone'))
                                        <span class="help-block">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="phone1" type="text" name="phone1" class="optional form-control col-md-7 col-xs-12" placeholder="Additional Phone Number">
                        </div>
                      </div>
                      ...
                      <div class="item form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password" type="password" name="password" class="form-control col-md-7 col-xs-12" required="required" placeholder="Type Password">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="password-confirm" type="password" name="password_confirmation" data-validate-linked="password" class="form-control col-md-7 col-xs-12" required="required" placeholder="Confirm Password">
                        </div>
                      </div>
